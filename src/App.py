...
# def get_table_schema(table_name, database='O3_DEV_DB', schema='O3_DEV_RAW_SCH'):
...
# def get_table_relationships(database='O3_DEV_DB', schema='O3_DEV_RAW_SCH'):
...
# def get_all_tables(database='O3_DEV_DB', schema='O3_DEV_RAW_SCH'):
...
# def initialize_multi_table_environment(database='O3_DEV_DB', schema='O3_DEV_RAW_SCH', table_list=None):
