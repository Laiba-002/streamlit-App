...
#         st.warning("The chatbot will not remember previous messages")
...
#                     st.session_state.vector_store = initialize_vector_store(df, table_name=st.session_state.table_name)
...
#                         # Save message without the dataframe
